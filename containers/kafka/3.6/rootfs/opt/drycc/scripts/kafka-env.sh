...
# Paths
export KAFKA_BASE_DIR="${DRYCC_ROOT_DIR}/kafka"
export KAFKA_VOLUME_DIR="/drycc/kafka"
...
export PATH="${KAFKA_BASE_DIR}/bin:${DRYCC_ROOT_DIR}/java/bin:${PATH}"
...
export KAFKA_INTER_BROKER_PASSWORD="${KAFKA_INTER_BROKER_PASSWORD:-drycc}"
export KAFKA_CONTROLLER_USER="${KAFKA_CONTROLLER_USER:-controller_user}"
export KAFKA_CONTROLLER_PASSWORD="${KAFKA_CONTROLLER_PASSWORD:-drycc}"
...
export KAFKA_CLIENT_PASSWORDS="${KAFKA_CLIENT_PASSWORDS:-drycc}"
