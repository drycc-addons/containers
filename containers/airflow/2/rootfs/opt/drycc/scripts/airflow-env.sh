...
airflow_env_vars=(
    ...
    AIRFLOW_CELERY_BROKER_TRANSPORT_OPTIONS
    AIRFLOW_LDAP_ENABLE
    AIRFLOW_LDAP_URI
    AIRFLOW_LDAP_SEARCH
...
export AIRFLOW_LOG_FILE="${AIRFLOW_LOGS_DIR}/airflow.log"
...
export AIRFLOW_PID_FILE="${AIRFLOW_TMP_DIR}/airflow.pid"
