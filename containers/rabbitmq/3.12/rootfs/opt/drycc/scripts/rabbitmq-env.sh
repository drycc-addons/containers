...
# Paths
export RABBITMQ_VOLUME_DIR="/drycc/rabbitmq"
export RABBITMQ_BASE_DIR="/opt/drycc/rabbitmq"
...
export PATH="${RABBITMQ_BIN_DIR}:${DRYCC_ROOT_DIR}/common/bin:${DRYCC_ROOT_DIR}/erlang/bin:${PATH}"
...
export RABBITMQ_PASSWORD="${RABBITMQ_PASSWORD:-drycc}"
