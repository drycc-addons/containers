...
# Paths
export APOLLO_VOLUME_DIR="/drycc/apollo-adminservice"
export APOLLO_BASE_DIR="${DRYCC_ROOT_DIR}/apollo-adminservice"
export APOLLO_CONF_FILE="${APOLLO_BASE_DIR}/apollo-adminservice.conf"
export APOLLO_SCRIPTS_DIR="${APOLLO_BASE_DIR}/scripts"
export APOLLO_LOG_FOLDER="${APOLLO_BASE_DIR}/logs"
export APOLLO_LOG_FILE="apollo-adminservice.console.log"
