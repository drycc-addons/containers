...
# Paths
export PATH="$DRYCC_ROOT_DIR/mongodb/bin:$DRYCC_ROOT_DIR/common/bin:$PATH"
export MONGODB_VOLUME_DIR="$DRYCC_VOLUME_DIR/mongodb"
export MONGODB_BASE_DIR="$DRYCC_ROOT_DIR/mongodb"
...
export MONGOSH_BASE_DIR="$DRYCC_ROOT_DIR/mongosh"
export MONGOSH_BIN_DIR="$MONGOSH_BASE_DIR/bin"
