...
# Paths
export DRYCC_VOLUME_DIR="/drycc"
export OPENSEARCH_DASHBOARDS_VOLUME_DIR="${DRYCC_VOLUME_DIR}/opensearch-dashboards"
export SERVER_VOLUME_DIR="$OPENSEARCH_DASHBOARDS_VOLUME_DIR"
export OPENSEARCH_DASHBOARDS_BASE_DIR="${DRYCC_ROOT_DIR}/opensearch-dashboards"
