...
. /opt/drycc/scripts/libpersistence.sh

# Load database library
if [[ -f /opt/drycc/scripts/libpostgresqlclient.sh ]]; then
    . /opt/drycc/scripts/libpostgresqlclient.sh
elif [[ -f /opt/drycc/scripts/libpostgresql.sh ]]; then
