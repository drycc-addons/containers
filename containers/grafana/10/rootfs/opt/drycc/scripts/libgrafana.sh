...
if [[ -f /opt/drycc/scripts/libmysqlclient.sh ]]; then
    . /opt/drycc/scripts/libmysqlclient.sh
elif [[ -f /opt/drycc/scripts/libmysql.sh ]]; then
    . /opt/drycc/scripts/libmysql.sh
elif [[ -f /opt/drycc/scripts/libmariadb.sh ]]; then
