...
1. Using `docker run`
    ...
    ```console
    $ docker run \
        -v /path/to/certs:/opt/drycc/postgresql/certs \
    ...
    services:
      ...
      ...
        environment:
          ...
          - POSTGRESQL_TLS_CERT_FILE=/opt/drycc/postgresql/certs/postgres.crt
          - POSTGRESQL_TLS_KEY_FILE=/opt/drycc/postgresql/certs/postgres.key
        ...
        volumes:
          ...
          - /path/to/certs:/opt/drycc/postgresql/certs
      ...
    ```
