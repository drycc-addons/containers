...
# Paths
export CLICKHOUSE_BASE_DIR="${DRYCC_ROOT_DIR}/clickhouse"
export CLICKHOUSE_VOLUME_DIR="/drycc/clickhouse"
...
export PATH="${CLICKHOUSE_BASE_DIR}/bin:${DRYCC_ROOT_DIR}/common/bin:$PATH"
