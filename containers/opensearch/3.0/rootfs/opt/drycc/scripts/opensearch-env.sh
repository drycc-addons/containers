...
opensearch_env_vars=(
    ...
    OPENSEARCH_TRANSPORT_TLS_ENFORCE_HOSTNAME_VERIFICATION
...
# Paths
export OPENSEARCH_VOLUME_DIR="/drycc/opensearch"
export DB_VOLUME_DIR="$OPENSEARCH_VOLUME_DIR"
export OPENSEARCH_BASE_DIR="/opt/drycc/opensearch"
...
export PATH="${DB_BIN_DIR}:${DRYCC_ROOT_DIR}/common/bin:$PATH"
...
export OPENSEARCH_PASSWORD="${OPENSEARCH_PASSWORD:-drycc}"
...
export OPENSEARCH_TRANSPORT_TLS_ENFORCE_HOSTNAME_VERIFICATION="${OPENSEARCH_TRANSPORT_TLS_ENFORCE_HOSTNAME_VERIFICATION:-false}"
export DB_TRANSPORT_TLS_ENFORCE_HOSTNAME_VERIFICATION="$OPENSEARCH_TRANSPORT_TLS_ENFORCE_HOSTNAME_VERIFICATION"
...
export OPENSEARCH_DASHBOARDS_PASSWORD="${OPENSEARCH_DASHBOARDS_PASSWORD:-drycc}"
export LOGSTASH_PASSWORD="${LOGSTASH_PASSWORD:-drycc}"
