...
# Paths
export REDIS_SENTINEL_VOLUME_DIR="/drycc/redis-sentinel"
export REDIS_SENTINEL_BASE_DIR="${DRYCC_ROOT_DIR}/redis-sentinel"
...
export PATH="${REDIS_SENTINEL_BIN_DIR}:${DRYCC_ROOT_DIR}/common/bin:${PATH}"
